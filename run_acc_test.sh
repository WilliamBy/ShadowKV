...
$PY test/eval_acc.py --datalen $DATALEN --method experimental --dataset_name $DATASETS --model_name "gradientai/Llama-3-8B-Instruct-Gradient-1048k" --sparse_budget 2048 --rank 160 --chunk_size 8 || exit 1
